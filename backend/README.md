...
## Project Structure
    ...
    ├── testapiautosetting_127225  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127225`
...
2. Clone this repo and `cd testapiautosetting_127225`
